...
//  Slot Game
//
//  Created by 嶋秀憲 on 2020/09/05.
//  Copyright © 2020 Hidenori Shima. All rights reserved.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            ...
            Rectangle()
                .foregroundColor(Color(red: 228/255, green: 195/225, blue: 76/255))
